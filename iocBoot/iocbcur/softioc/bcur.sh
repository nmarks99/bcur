...
# Manually set IOC_STARTUP_DIR if bcur.sh will reside somewhere other than softioc
#!IOC_STARTUP_DIR=/home/username/epics/ioc/synApps/bcur/iocBoot/iocbcur/softioc

# Manually set IOC_COMMAND_DIR if bcur.sh will reside somewhere other than softioc
#!IOC_COMMAND_DIR=/home/username/epics/ioc/synApps/bcur/iocBoot/iocbcur/softioc/commands
...
#!IOC_BIN_DIR=/home/username/epics/synApps/support/bcur/bin
...
checkpid() {
    MY_UID=`${ID} -u`
    # The '\$' is needed in the pgrep pattern to select bcur, but not bcur.sh
